...
import styles from "./StudiosMainPart.module.css";

function StudiosMainPart ({ zones }) {
  return (
          ...
          <div className={styles.zoneContent}>
            <div className={styles.imageWrapper}>
              {zone.equipment.map((item, idx) => {
                ...
                <img
                  key={idx}
                  src={require(`../../../../../assets/images/group-personal-programs/${item.img}`)}
                  alt={item.name}
...
export default StudiosMainPart;
