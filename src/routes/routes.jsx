...
//         { path: "club-cards", element: <ClubCardsAdmin /> }
...
import ClubCardsAdmin from "../admin/Modules/ClubCardsAdmin/ClubCardsAdmin"; // ⬅️ ДОДАНО
...
export const routes = createBrowserRouter([
  ...
  // Адмінка
  { path:"/gym-pool-website/admin/login", element:<Login />, errorElement:<ErrorPage /> },

  {
    ...
    children:[
      ...
      { path: "settings", element: <Settings /> },
      { path: "contacts", element: <Contacts /> },
      { path: "ageGroup" , element: <AgeGroupAdmin/> },   // ⚠️ зверни увагу на регістр
      { path: "news", element: <News /> },
      { path: "schedule", element: <AdminSchedule /> },
      { path: "price", element: <ClubCardsAdmin /> },     // ⬅️ ДОДАНО маршрут для цін
    ],
  },
]);
